...
A total of 7 servers was connected during the Hackathon, providing the participants with the scenario of a client running in the web browser served via HTTPS and the resulting security rules.
